...
}: { pagination: PaginationType, setPagination: Dispatch<SetStateAction<PaginationType>> }) {
    return (
        <div className="flex items-center gap-3">
            <div className="text-gray-500 text-sm">Rows per page</div>
            <Select value={pagination.pageSize.toString()} onValueChange={(value) => setPagination((prev) => ({
                ...prev,
